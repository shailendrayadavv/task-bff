...
var CompetitionsController = /** @class */ (function () {
    function CompetitionsController() {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        continentId = Number(req.query.continentId);
                        _b = (_a = res).json;
                        return [4 /*yield*/, this.userListService.fetch(sportId, page, continentId)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 3];
                    case 2:
        ...
        this.userListService = new services_1.CompetitionsServices();
    }
